...
type OpenOracleDeploymentRaw struct {
	Addresses OpenOracleContractsRaw `json:"addresses"`
}
type OpenOracleContractsRaw struct {
...
func NewConfig(ctx *cli.Context) (*Config, error) {
	...
	var credibleSquaringDeploymentRaw OpenOracleDeploymentRaw
...
func (c *Config) validate() {
	...
	if c.OpenOracleRegistryCoordinatorAddr == common.HexToAddress("") {
		panic("Config: OpenOracleRegistryCoordinatorAddr is required")
	}
}

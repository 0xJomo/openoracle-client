...
// Source: avs-oracle/core/chainio (interfaces: AvsSubscriberer)
//
// Generated by this command:
//
//	mockgen -destination=./mocks/avs_subscriber.go -package=mocks avs-oracle/core/chainio AvsSubscriberer
//
...
func (m *MockAvsSubscriberer) ParseTaskResponded(arg0 types.Log) (*contractOpenOracleTaskManager.ContractOpenOracleTaskManagerTaskResponded, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ParseTaskResponded", arg0)
	ret0, _ := ret[0].(*contractOpenOracleTaskManager.ContractOpenOracleTaskManagerTaskResponded)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAvsSubscriberer) SubscribeToNewTasks(arg0 chan *contractOpenOracleTaskManager.ContractOpenOracleTaskManagerNewTaskCreated) event.Subscription {
	m.ctrl.T.Helper()
...
func (m *MockAvsSubscriberer) SubscribeToTaskResponses(arg0 chan *contractOpenOracleTaskManager.ContractOpenOracleTaskManagerTaskResponded) event.Subscription {
	m.ctrl.T.Helper()

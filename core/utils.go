...
// this hardcodes abi.encode() for cstaskmanager.IOpenOracleTaskManagerTaskResponse
// unclear why abigen doesn't provide this out of the box...
func AbiEncodeTaskResponse(h *cstaskmanager.IOpenOracleTaskManagerTaskResponse) ([]byte, error) {

	// The order here has to match the field ordering of cstaskmanager.IOpenOracleTaskManagerTaskResponse
...
func GetTaskResponseDigest(h *cstaskmanager.IOpenOracleTaskManagerTaskResponse) ([32]byte, error) {

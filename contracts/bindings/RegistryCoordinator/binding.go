...
// IRegistryCoordinatorOperatorBlsKeyAndSigner is an auto generated low-level Go binding around an user-defined struct.
type IRegistryCoordinatorOperatorBlsKeyAndSigner struct {
	Pubkey     BN254G1Point
	PubkeyHash [32]byte
